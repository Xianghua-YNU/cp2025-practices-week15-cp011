...
if __name__ == "__main__":
    ...
    plt.plot(0, 0, 'ko', markersize=10, label='Central Body (Sun)')
    ...
    # Check that (E_target + GM/r0) > 0 for a real orbit
    if E_target + GM * mass_particle / r0 < 0:
        ...
        for angle_deg in launch_angles_deg:
            ...
            print(f"  Angle {angle_deg}°: Calculated E={current_E:.3f} (Target E={E_target:.3f}), Lz={current_Lz:.3f}")
